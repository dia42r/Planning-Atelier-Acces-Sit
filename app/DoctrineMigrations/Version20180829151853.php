 ...
 */
final class Version20180829151853 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE task (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sale_document_line (id VARCHAR(255) NOT NULL, item_id VARCHAR(255) DEFAULT NULL, documentId VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, quantity INT NOT NULL, realQuantity INT DEFAULT NULL, deliveryDate DATETIME DEFAULT NULL, deliveryState VARCHAR(60) DEFAULT NULL, comment VARCHAR(255) DEFAULT NULL, status VARCHAR(30) DEFAULT NULL, status_bis VARCHAR(30) DEFAULT NULL, total_time TIME DEFAULT NULL, total_prev TIME DEFAULT NULL, documentWishDate DATE DEFAULT NULL, saleDocument_id VARCHAR(255) DEFAULT NULL, Planification_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_5727BE81F16E39BF (Planification_id), INDEX IDX_5727BE81DBBCE3DC (saleDocument_id), INDEX UNIQ_5727BE81126F525E (item_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE item_family (id INT AUTO_INCREMENT NOT NULL, caption VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sale_document (id VARCHAR(255) NOT NULL, documentdate DATETIME NOT NULL, documentnumber VARCHAR(255) NOT NULL, customerName VARCHAR(255) NOT NULL, numberPrefix VARCHAR(20) NOT NULL, total_time TIME DEFAULT NULL, catEnd TINYINT(1) NOT NULL, status VARCHAR(40) DEFAULT NULL, documentWishDate DATE DEFAULT NULL, total_prev TIME DEFAULT NULL, documentEndDateFabric DATE DEFAULT NULL, starting_date DATETIME DEFAULT NULL, end_date DATETIME DEFAULT NULL, documentValidDate DATE DEFAULT NULL, customer_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_C61D66DC750985BA (documentnumber), INDEX IDX_C61D66DC9395C3F3 (customer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE item (id VARCHAR(255) NOT NULL, family_id INT DEFAULT NULL, caption VARCHAR(255) NOT NULL, desComm VARCHAR(255) DEFAULT NULL, note VARCHAR(255) DEFAULT NULL, itemSubfamily_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_1F1B251EC35E566A (family_id), UNIQUE INDEX UNIQ_1F1B251EF1D5CC63 (itemSubfamily_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE item_sub_family (id INT AUTO_INCREMENT NOT NULL, caption VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE item ADD CONSTRAINT FK_1F1B251EF1D5CC63 FOREIGN KEY (itemSubfamily_id) REFERENCES item_sub_family (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE item DROP FOREIGN KEY FK_1F1B251EF1D5CC63');
        ...
        $this->addSql('DROP TABLE item_sub_family');
    }
}
