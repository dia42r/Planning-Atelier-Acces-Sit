...
final class Version20180829151853 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE item (id VARCHAR(255) NOT NULL, family_id INT DEFAULT NULL, caption VARCHAR(255) NOT NULL, desComm LONGTEXT DEFAULT NULL, note VARCHAR(255) DEFAULT NULL, itemSubfamily_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_1F1B251EC35E566A (family_id), UNIQUE INDEX UNIQ_1F1B251EF1D5CC63 (itemSubfamily_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE UTF8_unicode_ci ENGINE = InnoDB');
