 ...
 */
class Version20180321183747 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE actor ADD deg LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE actor DROP deg');
