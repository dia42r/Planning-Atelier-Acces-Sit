 ...
 */
class Version20180321184838 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE actor CHANGE deg deg LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE actor CHANGE deg deg LONGTEXT NOT NULL COLLATE utf8_unicode_ci COMMENT \'(DC2Type:array)\'');
